  ...
  return (
    <>
      <header
        ...
        style={{ padding: '10px', borderBottom: '1px solid #D1D1D1', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', backgroundColor: '#FFFFFF' }}
        role="banner"
        aria-label="상단 네비게이션"
      >
        <div className="flex items-center justify-between w-full" style={{ paddingLeft: '12px', paddingRight: '12px' }}>
