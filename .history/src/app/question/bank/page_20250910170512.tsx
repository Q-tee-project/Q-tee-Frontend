            ...
            <CardHeader className="flex flex-row items-center justify-between py-4 px-6 border-b border-gray-100">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="text-[#0072CE] hover:text-[#0056A3] transition-colors inline-flex items-center justify-center w-8 h-8 rounded-md hover:bg-[#EBF6FF]"
                  title="새로고침"
                >
                ...
                <div className="flex gap-3">
                  {worksheetProblems.length > 0 && (
                    <button
                      ...
                      className="px-4 py-2 bg-white/80 backdrop-blur-sm border border-[#0072CE]/30 text-[#0072CE] rounded-md text-sm font-medium hover:bg-[#0072CE]/10 hover:border-[#0072CE]/50 transition-all duration-200 flex items-center gap-2 shadow-sm"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
