...
export default function BankPage() {
  ...
  const mockRecipients = [
    ...
    { id: '2', name: '김민수', school: '서울중학교', level: '중등', grade: '2학년' },
    { id: '3', name: '박지영', school: '강남고등학교', level: '고등', grade: '3학년' },
    { id: '4', name: '정현우', school: '부산중학교', level: '중등', grade: '1학년' },
    { id: '5', name: '최서연', school: '대구고등학교', level: '고등', grade: '2학년' },
    { id: '6', name: '한지훈', school: '인천중학교', level: '중등', grade: '3학년' },
  ];
        ...
        <DialogContent className="max-w-4xl w-full">
            ...
            <div className="flex-1">
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                <div className="max-h-80 overflow-y-auto">
                  {mockClasses.map((cls) => (
                    <div key={cls.id} className="flex items-center gap-3 p-3 border-b border-gray-100 last:border-b-0 hover:bg-gray-50">
                      <input
                        type="checkbox"
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                <div className="max-h-80 overflow-y-auto">
                  {mockRecipients.map((recipient) => (
                    <div key={recipient.id} className="flex items-center gap-3 p-3 border-b border-gray-100 last:border-b-0 hover:bg-gray-50">
                      <input
                        type="checkbox"
          ...
          <DialogFooter className="flex justify-between">
            ...
            <Button
              ...
              className="bg-[#0072CE] hover:bg-[#0056A3]"
            >
              배포
            </Button>
          </DialogFooter>
