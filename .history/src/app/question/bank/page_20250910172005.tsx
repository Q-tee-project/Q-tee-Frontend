...
export default function BankPage() {
  ...
  const mockRecipients = [
    ...
    { id: '2', name: '김병천', school: '서울중학교', level: '중등', grade: '2학년' },
    { id: '3', name: '김보연', school: '강남고등학교', level: '고등', grade: '3학년' },
    { id: '4', name: '한광구', school: '부산중학교', level: '중등', grade: '1학년' },
    { id: '5', name: '최현범', school: '대구고등학교', level: '고등', grade: '2학년' },
  ];
