              ...
              <div className="space-y-4 mb-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) => onEditFormDataChange({...editFormData, question_text: e.target.value})}
                    rows={3}
                    className="w-full"
                  />
                </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div>
                    ...
                    <Select value={editFormData.question_type || '객관식'} onValueChange={(value) => onEditFormDataChange({...editFormData, question_type: value})}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  <div>
                    ...
                    <Select value={editFormData.question_subject || '독해'} onValueChange={(value) => onEditFormDataChange({...editFormData, question_subject: value})}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  <div>
                    ...
                    <Select value={editFormData.question_difficulty || '중'} onValueChange={(value) => onEditFormDataChange({...editFormData, question_difficulty: value})}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                ...
                {question.example_content && (
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => onEditFormDataChange({...editFormData, example_content: e.target.value})}
                      rows={2}
                        ...
                        <div key={index} className="flex items-center gap-2">
                          ...
                          <Input
                            ...
                            onChange={(e) => {
                              ...
                              onEditFormDataChange({...editFormData, question_choices: newChoices});
                            }}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    {editFormData.question_type === '객관식' ? (
                      <Select
                        ...
                        onValueChange={(value) => onEditFormDataChange({...editFormData, correct_answer: value})}
                      >
                        <SelectTrigger>
                      ...
                      <Input
                        value={editFormData.correct_answer || ''}
                        onChange={(e) => onEditFormDataChange({...editFormData, correct_answer: e.target.value})}
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => onEditFormDataChange({...editFormData, question_detail_type: e.target.value})}
                      placeholder="세부 유형"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) => onEditFormDataChange({...editFormData, explanation: e.target.value})}
                    rows={3}
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) => onEditFormDataChange({...editFormData, learning_point: e.target.value})}
                    rows={2}
