...
const TeacherDashboard = React.memo(() => {
  ...
  }, [loadMarketStats, loadMarketProducts, loadRealClasses, loadRealStats, loadRealStudents, loadRealAssignments, selectedClass]);
    ...
    const interval = setInterval(async () => {
      ...
      if (realStudents[selectedClass]) {
        try {
          ...
          if (classStudents.length !== currentStudents.length || 
              !classStudents.every((student, index) => 
